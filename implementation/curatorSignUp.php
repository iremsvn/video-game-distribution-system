...
if($xxx == "POST"){	
	if (isset($_POST['btnConfirmType'])) {
				...
				$result2 = mysqli_query($db, "INSERT INTO curator (email) VALUES ('$email')");
				if (!$result2) {
					printf("Error: %s\n", mysqli_error($db));
					exit();
					//header("location: index.php");
...
<div class="container">
	...
	<p><a></a></p>
        <div id="two">
			<br><br>
			<br><br>
			<h3 id="myHeader" class="page-header" style="font-weight: bold;" >Confirm To Create Your Account as Curator Account</h3>

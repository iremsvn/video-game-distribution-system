...
if($xxx == "POST"){
				...
				$result2 = mysqli_query($db, "INSERT INTO developer (comp_name, email) VALUES ('$comp_name', '$email')");
				if (!$result2) {
					printf("Error: %s\n", mysqli_error($db));
					exit();
					//header("location: index.php");
...
<div class="container">
	...
	<p><a></a></p>
        <div id="two">
			<br><br>
			<br><br>
			<h3 id="myHeader" class="page-header" style="font-weight: bold;" >Confirm To Create Your Developer Account</h3>
			<h3 id="myHeader" class="page-header" style="font-weight: bold;" >After Confirming You Can Login the System</h3>
			<h3 id="myHeader" class="page-header" style="font-weight: bold;" >Make Sure to Provide Official Company Name</h3>
			<br><br>
            <form id="logining" action="" method="post">
                <div class="form-group">
                    <input type="comp_name" name="comp_name" class="form-control" id="comp_name" placeholder="company name">
...
function checkEmpty() {
		var devVal = document.getElementById("comp_name").value;
        if (devVal === "" ) {
